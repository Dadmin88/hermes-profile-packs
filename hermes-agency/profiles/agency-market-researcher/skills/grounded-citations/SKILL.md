...
```bash
S="$HERMES_HOME/skills/grounded-citations/scripts/sources.py"
...
python3 "$S" --ledger /tmp/task-ledger.json reset
python3 "$S" --ledger /tmp/task-ledger.json add https://example.com/a
```
